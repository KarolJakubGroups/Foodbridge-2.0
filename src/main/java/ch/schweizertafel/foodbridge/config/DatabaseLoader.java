...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        User migros = users.save(new User("migros", DEMO_PASSWORD, Role.DONOR, "Migros Genossenschaft Zürich",
                "Limmatstrasse 152, 8005 Zürich"));
        User coop = users.save(new User("coop", DEMO_PASSWORD, Role.DONOR, "Coop Verteilzentrale Dietikon",
                "Riedstrasse 10, 8953 Dietikon"));
        User foodbank = users.save(new User("foodbank_zrh", DEMO_PASSWORD, Role.FOODBANK,
                "Schweizer Tafel Abgabestelle Zürich", "Hohlstrasse 400, 8048 Zürich"));
        users.save(new User("dispatcher_gt", DEMO_PASSWORD, Role.DISPATCHER, "Galliker Transport AG",
